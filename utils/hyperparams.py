...
class HyperParameterHandler(object):
    ...
    def check_changed(self, new_params):
        if self.check_exists():
            ...
            return (old_params["num_layers"] != new_params["num_layers"]
                    or old_params["hidden_size"] != new_params["hidden_size"]
                    or old_params["max_seq_length"] != new_params["max_seq_length"]
                    or old_params["max_vocab_size"] != new_params["max_vocab_size"])
        else:
            return False

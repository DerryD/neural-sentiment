# neural-sentiment
This code was forked from https://github.com/inikdom/neural-sentiment
...
1. Python 2.7.x
2. Install [tensorflow-gpu==1.1.0](https://www.tensorflow.org/versions/master/get_started/os_setup.html)
